<%-- 
    Document   : product
    Created on : Jul 15, 2018, 9:13:43 AM
    Author     : Admin
--%>
			...
			<div class="content">
				<div class="content-top">
					...
					<div class="content-top-in">
						<div class="col-md-3 md-col">
							<div class="col-md">
								...
								<div class="top-content">
									<h5><a href="single.html">Giày đá bóng</a></h5>
									<div class="white">
										<a href="single.html" class="hvr-shutter-in-vertical hvr-shutter-in-vertical2 ">Thêm vào giỏ</a>
						...
						<div class="col-md-3 md-col">
							<div class="col-md">
								<a href="single.html"><img  src="images/giay8.jpg" alt="" />	</a>
								<div class="top-content">
						...
						<div class="col-md-3 md-col">
							<div class="col-md">
								...
								<div class="top-content">
									<h5><a href="single.html">Real</a></h5>
									<div class="white">
										<a href="single.html" class="hvr-shutter-in-vertical hvr-shutter-in-vertical2">ADD TO CART</a>
