...
public final class insert_005fproduct_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t<tr><td><b>Tên sản phẩm</b></td><td><input id=\"txtTensp\" type=\"text\" class=\"sedang\"></td></tr>\n");
      out.write("                        <tr><td><b>Giá bán</b></td><td><input id=\"txtGia\" type=\"text\" class=\"sedang\"></td></tr>\n");
      out.write("\t\t\t<tr><td><b>Loại sản phẩm</b></td><td>\n");
      out.write("\t\t\t\t<select>\n");
      out.write("\t\t\t\t\t<option selected>-- Chọn loại sản phẩm --</option>\n");
      out.write("\t\t\t\t\t<option value=\"ar\">Arsenal</option>\n");
      out.write("                                        <option value=\"ba\">Barcelona</option>\n");
      out.write("                                        <option value=\"re\">Real Madrid</option>\n");
      out.write("                                        <option value=\"ma\">Manchester City</option>\n");
      out.write("\t\t\t\t</select>\n");
      out.write("\t\t\t</td></tr>\n");
      ...
      out.write("                            </td>\n");
      out.write("                        </tr>\n");
      out.write("                        <tr><td><b>Hình ảnh</b></td><td><input type=\"file\"></td></tr>\n");
      out.write("\t\t\t<tr><td></td><td>\n");
      out.write("\t\t\t<input type=\"button\" class=\"button\" value=\"Button\">\n");
      out.write("                        <input type=\"submit\" class=\"button\" onclick=\"submit()\">\n");
      ...
      out.write("                var tensp = document.getElementById(\"txtTensp\")\n");
      out.write("                var gia = document.getElementById(\"txtGia\")\n");
      out.write("                console.log(tensp + \" \"+gia)\n");
      out.write("            }           \n");
      out.write("            </script>\n");
      out.write("         ");
